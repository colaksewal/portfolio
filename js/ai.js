$(document).ready(function() {
    ...
    $("#nanogallery2").nanogallery2({
        ...
        items: [
            { src: 'image/ai-image1.png', srct: 'image/ai-image1.png', title: 'Image 1' },
            { src: 'image/ai-image2.png', srct: 'image/ai-image2.png', title: 'Image 2' },
            { src: 'image/ai-image3.png', srct: 'image/ai-image3.png', title: 'Image 3' }
        ]
    });
});
