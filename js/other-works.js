$(document).ready(function() {
    ...
    $.ajax({
        url: "works/other-works.json", // JSON file URL
    ...
    $("#nanogallery2").nanogallery2({
        ...
        items: [
            { src: 'image/other1.png', srct: 'image/other1.png', title: 'Title 1' },
            { src: 'image/other2.png', srct: 'image/other2.png', title: 'Title 2' }
